  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "shadow-float": "0 18px 40px -18px rgba(0,0,0,0.35)",
        "lovable-card": "0 1px 2px rgba(0,0,0,0.04), 0 8px 24px -12px rgba(0,0,0,0.12)",
        "lovable-float": "0 18px 40px -18px rgba(0,0,0,0.35)",
      },
      backgroundImage: {
        "gradient-brand": "linear-gradient(135deg, oklch(0.72 0.16 165), oklch(0.55 0.19 292))",
        "brand-gradient": "linear-gradient(135deg, oklch(0.72 0.16 165), oklch(0.55 0.19 292))",
      },
      transitionTimingFunction: {
        "luxury": "cubic-bezier(0.4, 0, 0.2, 1)",
        "lovable": "cubic-bezier(0.4, 0, 0.2, 1)",
      },
      keyframes: {
        "fade-up": {

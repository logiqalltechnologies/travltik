export default {
  ...
  documents: [
    ...
    },
    {
      ...
      description: 'Completed and signed Kosovo visa application form generated via the official visa portal',
      icon: 'form',
      mandatory: true
    },
    {
  ...
  steps: [
    {
      ...
      description: 'Complete the visa application form on the official MFA Kosovo Visa portal (visa.rks-gov.net)'
    },
    {
      step: 2,

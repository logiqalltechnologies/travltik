export default {
  ...
  documents: [
    ...
    { key: 'photographs', title: 'Passport Photographs (35×45mm)', description: 'Two recent biometric photos, white background, neutral expression, taken within last 6 months', icon: '📸', mandatory: true },

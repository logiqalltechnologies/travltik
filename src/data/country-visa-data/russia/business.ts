export default {
  ...
  documents: [
    ...
    { key: 'invitation_letter', title: 'Business Invitation Letter', description: 'Official invitation from Russian host company approved by MFA/GUVM (mandatory for Sticker, not required for eVisa)', icon: '✉️', mandatory: false },
  ...
  steps: [
    { step: 1, title: 'Select Application Mode', description: 'For stays up to 16 days → Unified eVisa. For longer or multiple-entry stays → Regular Sticker Visa' },
    { step: 2, title: 'Obtain Documentation', description: 'For Sticker Visa: Get Business Invitation from Russian host company' },

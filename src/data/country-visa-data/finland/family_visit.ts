export default {
  ...
  documents: [
    ...
    { key: 'relationship_proof', title: 'Proof of Relationship', description: 'Birth certificate, marriage certificate, or other relationship documents', icon: '👨‍👩‍👧', mandatory: true },

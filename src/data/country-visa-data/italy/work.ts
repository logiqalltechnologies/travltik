export default {
  ...
  fees: {
    ...
    stickerConsularStandard: '€116 (~₹10,440)',
    vfsServiceFee: '₹2,000'
  },
  eVisa: {
    available: false,
  ...
  stayDuration: {
    ...
    stickerMultiple: 'Duration of work contract (renewable)'
  },
  entryType: 'Multiple Entry',
  documents: [
    { key: 'passport', title: 'Valid Indian Passport', description: 'Valid for at least 6 months beyond intended stay, issued within 10 years, 2 blank pages', icon: '📘', mandatory: true },
    ...
    { key: 'medical_certificate', title: 'Medical Certificate', description: 'Health certificate including HIV test', icon: '🩺', mandatory: true },

export default {
  ...
  stayDuration: {
    ...
    stickerMultiple: '1 Year / Duration of Study Course (National Visa Type D, renewable in Italy)'
  },
  ...
  documents: [
    ...
    },
    {
      ...
      description: 'Documentation demonstrating personal or parental financial coverage (minimum ~€6,079.45 per academic year / €467.65 per month). Acceptable: Sanctioned Education Loan, personal bank account statements (last 6 months with official bank seal), or official Italian/European scholarship award letter.',
      icon: 'bank',
      mandatory: true
    },
    {

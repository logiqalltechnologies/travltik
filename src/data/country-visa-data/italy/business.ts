export default {
  ...
  processingTime: {
    ...
    expressSticker: '15-30 working days (subject to peak seasonal demand)'
  },
  fees: {
    eVisaTotal: 'N/A',
    stickerConsularStandard: '90 EUR (payable in INR as per official diplomatic exchange rate)',
    vfsServiceFee: 'approx. ₹1,400 - ₹2,000 INR (VFS service fee + biometric fee)'
  },
  eVisa: {
    available: false,
    portal: 'N/A (Schengen visas require physical application and biometric submission)',

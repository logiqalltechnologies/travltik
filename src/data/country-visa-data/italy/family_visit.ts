export default {
  ...
  documents: [
    ...
    { key: 'invitation_letter', title: 'Invitation Letter (Dichiarazione di Ospitalità)', description: 'Official hospitality declaration from Italian host registered at local police station', icon: '✉️', mandatory: true },
    { key: 'host_id_proof', title: 'Host ID/Residence Proof', description: 'Copy of host passport or Italian residence permit', icon: '🪪', mandatory: true },
  ...
  specialRequirements: {
    entry_rules: 'Schengen 90/180 rule applies. Dichiarazione di Ospitalità must be registered at local police station (Questura) in Italy. Travel insurance mandatory.'
  }
};
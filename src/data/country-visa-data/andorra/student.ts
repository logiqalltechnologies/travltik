export default {
  ...
  channels: [
    ...
    'VFS Global (for Schengen visa application)',
    'Servei d\'Immigració del Govern d\'Andorra (for residence permit application in Andorra)'
  ],
  processingTime: {
    eVisa: 'Not Applicable',
    standardSticker: '15-21 working days (for Schengen long-stay visa)',
    expressSticker: 'Not available for this category'
  },
  fees: {
    eVisaTotal: 'Not Applicable',
    stickerConsularStandard: '€90 EUR (~₹8,100 INR) for Schengen long-stay visa; €200 EUR (~₹18,000 INR) for Andorran residence permit (paid in Andorra)',
  ...
  stayDuration: {
    eVisa: 'Not Applicable',
    stickerSingleDouble: 'Duration of studies (as per Andorran residence permit)',
    stickerMultiple: 'Duration of studies (as per Andorran residence permit)'
  },
  ...
  steps: [
    ...
    { step: 2, title: 'Apply for a Long-Stay Multiple-Entry Schengen Visa', description: 'Submit your application for a long-stay (Type D) multiple-entry Schengen visa through the Spanish or French Embassy/Consulate or their authorized visa application centers (e.g., VFS Global) in India, as Andorra is only accessible via these countries.' },

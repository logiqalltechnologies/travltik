export default {
  ...
  channels: [
    ...
    'VFS / BLS / TLS Application Centre (for Schengen visa application)',
  ...
  processingTime: {
    eVisa: 'N/A',
    standardSticker: 'Schengen Visa: 10-15 working days; Andorran Active Residency Permit: Several weeks to 2 months (subject to annual quota availability)',
    expressSticker: 'N/A'
  },
  fees: {
    eVisaTotal: 'N/A',
    stickerConsularStandard: 'Schengen Visa Consular Fee: 90 EUR (~₹ 8,000-9,000 INR, approximate conversion); Andorran Active Residency Permit Application Fee: 1,200 EUR (~₹ 108,000-120,000 INR, approximate conversion)',
    vfsServiceFee: 'Applicable outsourced service fee for Schengen visa (e.g., VFS/BLS/TLS) - To be confirmed (~₹ INR)'
  },
  eVisa: {
    available: false,
    portal: 'N/A',

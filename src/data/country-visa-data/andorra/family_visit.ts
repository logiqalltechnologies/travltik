export default {
  ...
  channels: [
    'VFS Global (or other authorized Schengen visa application centers for France/Spain)',
  ...
  fees: {
    ...
    stickerConsularStandard: '90 EUR (~₹9,870 - ₹10,100)',
    vfsServiceFee: '₹1,933 - ₹3,111 (approx. 22 EUR)'
  },
  eVisa: {
    available: false,
  ...
  steps: [
    ...
    { step: 3, title: 'Book Appointment and Submit Application', description: 'Book an appointment online with VFS Global or the respective Embassy/Consulate, pay the consular and service fees, and submit your application along with biometrics.' },

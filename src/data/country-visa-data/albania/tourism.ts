export default {
  ...
  processingTime: {
    eVisa: '15 working days (can extend up to 30 working days during peak season)',
    standardSticker: '15-30 working days',
    expressSticker: 'Not officially specified'
  },
  fees: {
    eVisaTotal: 'EUR 15 (~₹1,350)', // Based on an estimated conversion of 1 EUR = 90 INR
    stickerConsularStandard: 'INR 1,250',
    vfsServiceFee: 'INR 5,000 (Applicable outsourced service fee)'
  },
  eVisa: {
    available: true,
    ...
    processing: '15 working days (can extend up to 30 working days)'
  },
  stayDuration: {

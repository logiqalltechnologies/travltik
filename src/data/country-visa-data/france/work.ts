export default {
  ...
  eVisa: {
    ...
    maxStay: 'As per employment contract duration',
  ...
  steps: [
    ...
    },
    {
      ...
      description: 'Attend the appointment to submit original documents, provide biometric data, and pay the €90 consular fee and VFS service charge.'
    },
    {
      step: 5,

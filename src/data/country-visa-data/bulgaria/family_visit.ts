export default {
  ...
  steps: [
    ...
    },
    {
      ...
      description: 'Attend the appointment to submit physical documents, pay the 90 EUR consular fee plus VFS service fees, and enroll biometrics.'
    },
    {
      step: 5,
  ...
  specialRequirements: {
    entry_rules: 'The original Invitation-Declaration certified by the Bulgarian Migration Directorate must be presented upon visa application. Applicants must possess minimum funds of €50 per day (minimum €500 total) unless full financial support is explicitly declared by the host in the official invitation.'
  }
};
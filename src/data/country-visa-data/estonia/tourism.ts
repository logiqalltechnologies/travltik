export default {
  ...
  steps: [
    ...
    },
    {
      ...
      description: 'Attend the VFS application center to submit physical documents, pay the 90 EUR consular fee plus service fees, and complete biometric data collection.'
    },
    {
      step: 4,

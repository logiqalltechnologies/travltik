export default {
  ...
  fees: {
    ...
    stickerConsularStandard: '80 EUR (~₹8,880)',
  ...
  steps: [
    ...
    { step: 4, title: 'Submit Application & Pay Fee', description: 'Attend the appointment to submit your documents and provide biometrics (fingerprints and photograph). Pay the statutory consular fee (80 EUR) and the applicable service fee.' },

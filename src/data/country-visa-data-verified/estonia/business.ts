export default {
  ...
  documents: [
    ...
    { key: 'visa_form', title: 'Schengen Visa Application Form', description: 'Completed and signed online application form via Estonian MFA e-Application portal', icon: '📋', mandatory: true },
  ...
  steps: [
    { step: 1, title: 'Complete Application Form', description: 'Fill online Schengen visa application form on the Estonian MFA portal' },

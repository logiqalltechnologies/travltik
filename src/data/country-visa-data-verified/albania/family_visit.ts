export default {
  ...
  externalServiceProvider: 'Direct (Albanian eVisa portal) // No VFS/third‑party provider for Indian applicants',
  processingTime: {
  ...
  fees: {
    eVisaTotal: 'EUR 35', // Official e‑Visa fee for Indian passport holders (Type C)
    stickerConsularStandard: 'EUR 35 (single entry) / EUR 45 (multiple entry)', // Official consular fee for Type C visa
  ...
  steps: [
    ...
    { step: 4, title: 'Pay Visa Fee', description: 'Pay the non-refundable visa fee of EUR 35 online using a credit or debit card. Failure to pay within 15 days may result in application cancellation.' },

export default {
  ...
  fees: {
    ...
    stickerConsularStandard: 'EUR 35 (short‑stay Type C business visa)',
    stickerConsularLongStay: 'EUR 80 (long‑stay Type D business visa, if applicable)',
    vfsServiceFee: '₹1,000 - ₹2,000 (if applying via an outsourced service provider)'
  },
  externalServiceProvider: 'VFS Global',
  eVisa: {
    available: true,
    portal: 'https://evisa.al/',
  ...
  steps: [
    ...
    { step: 2, title: 'Complete Online Application Form', description: 'Visit the official Albania eVisa portal (evisa.al) and accurately fill out the online visa application form. Upload scanned copies of required documents.' },

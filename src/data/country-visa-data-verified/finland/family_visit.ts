export default {
  ...
  authority: 'Ministry for Foreign Affairs of Finland / Embassy of Finland in New Delhi',
  channels: ['VFS Global', 'Embassy of Finland in New Delhi'],
  processingTime: {
  ...
  documents: [
    ...
    { key: 'photographs', title: 'Passport Photographs (35×45mm)', description: 'Two recent color photos (taken within last 6 months), white background', icon: '📸', mandatory: true },
    { key: 'visa_form', title: 'Schengen Visa Application Form', description: 'Completed and signed application form', icon: '📋', mandatory: true },
    { key: 'invitation_letter', title: 'Invitation Letter from Host', description: 'Official invitation from family member in Finland with host details and relationship proof', icon: '✉️', mandatory: true },
    { key: 'host_id_proof', title: 'Host ID/Residence Proof', description: 'Copy of host passport or Finnish residence permit', icon: '🪪', mandatory: true },
    { key: 'relationship_proof', title: 'Proof of Relationship', description: 'Birth certificate, marriage certificate, or other official relationship documents', icon: '👨‍👩‍👧', mandatory: true },
  ...
  steps: [
    ...
    { step: 2, title: 'Book VFS Appointment', description: 'Schedule appointment at VFS Global Finland Centre' },
  ...
  specialRequirements: {
    entry_rules: 'Schengen 90/180 rule applies. Invitation letter must include host contact details and relationship. Travel insurance mandatory.'
  }
};
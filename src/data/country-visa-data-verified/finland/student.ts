export default {
  ...
  processingTime: {
    eVisa: '60-90 working days',
    standardSticker: '60-90 working days',
    expressSticker: '30 working days (fast‑track for Master degree students and researchers)'
  },
  fees: {
    eVisaTotal: '€470 (Electronic Residence Permit Application Fee)',
    stickerConsularStandard: '€470 (Paper Application Fee)',
  ...
  eVisa: {
    ...
    processing: '60-90 working days'
  },
  maximumPermittedStayDays: 1460,
  stayDuration: {
  ...
  steps: [
    ...
    },
    {
      ...
      description: 'Create an account on enterfinland.fi, complete the study residence permit application, attach mandatory documents, and pay the €470 fee online.'
    },
    {
      step: 3,

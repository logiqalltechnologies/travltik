export default {
  ...
  channels: [
    'Official eVisa Portal (evisa.belarus.by)',
  ...
  processingTime: {
    ...
    expressSticker: '2 business days (48 hours)'
  },
  fees: {
    eVisaTotal: 'EUR 66 (~₹5940)', // EUR 60 consular + EUR 6 service fee
    stickerConsularStandard: 'EUR 60 (~₹5400)', // Single‑entry short‑term tourist visa
    stickerConsularMultiple: 'EUR 80 (~₹7200)', // Multiple‑entry short‑term tourist visa
    vfsServiceFee: 'Not applicable (apply directly via Embassy or eVisa portal)'
  },
  eVisa: {
    available: true,
    portal: 'https://evisa.belarus.by',
  ...
  stayDuration: {
    eVisa: 'Up to 30 days per stay',
    stickerSingleDouble: 'Up to 30 days per stay (single or double entry)',
    stickerMultiple: 'Up to 90 days total within 180 days (multiple entry)'
  },

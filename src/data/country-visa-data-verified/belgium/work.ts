export default {
  ...
  processingTime: { eVisa: 'N/A', standardSticker: '15-45 working days (after work permit approval)', expressSticker: 'N/A' },
  fees: { eVisaTotal: 'N/A', stickerConsularStandard: '180 EUR', vfsServiceFee: 'Approx. 2,500 - 3,000 INR (varies by location)' },
  eVisa: { available: false, portal: 'N/A', territorialScope: 'N/A', validity: 'N/A', maxStay: 'N/A', invitationRequired: false, processing: 'N/A' },
  stayDuration: { eVisa: 'N/A', stickerSingleDouble: '90 days (for entry to apply for residence permit)', stickerMultiple: 'N/A' },
  ...
  steps: [
    ...
    { step: 4, title: 'Schedule Appointment', description: 'Book an appointment with VFS Global, the official visa application center for Belgium in India, or directly with the Embassy/Consulate if applicable.' },
    { step: 5, title: 'Submit Application and Pay Fees', description: 'Attend the appointment, submit the complete application dossier, and pay the consular visa fee (180 EUR) and the VFS Global service fee.' },

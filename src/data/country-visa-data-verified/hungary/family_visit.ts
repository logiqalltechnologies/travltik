export default {
  ...
  authority: 'Ministry of Foreign Affairs and Trade of Hungary / Embassy of Hungary in New Delhi',
  channels: ['VFS Global', 'Embassy of Hungary in New Delhi', 'Consulate General in Mumbai'],
  processingTime: {
  ...
  documents: [
    ...
    { key: 'invitation_letter', title: 'Invitation Letter from Host', description: 'Official invitation from family member in Hungary with host details and relationship proof', icon: '✉️', mandatory: true },
    { key: 'host_id_proof', title: 'Host ID/Residence Proof', description: 'Copy of host passport or Hungarian residence permit', icon: '🪪', mandatory: true },
  ...
  steps: [
    ...
    { step: 2, title: 'Book VFS Appointment', description: 'Schedule appointment at VFS Global Hungary Centre' },

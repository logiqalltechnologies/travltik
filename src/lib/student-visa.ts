...
export function getStudentOverview(country: string): string {
  ...
  const map: Record<string, string> = {
    'usa': 'You need an F-1 Student Visa to study full-time at a US college or university.',
    'canada': 'You need a Study Permit to pursue full-time academic courses at a Canadian DLI.',
    'uk': 'You need a UK Student Route Visa to study full-time at an approved British university.',
    'australia': 'You need a Subclass 500 Student Visa to study full-time at an Australian institution.',
    'germany': 'You need a German National Student Visa (Type D) to enroll in a degree program in Germany.',
    'france': 'You need a French Long-Stay Student Visa (VLS-TS) to study full-time in France.',
    'ireland': 'You need an Irish Long Stay Student Visa (Type D) to study full-time in Ireland.',
    'italy': 'You need an Italian National Student Visa (Type D) to study full-time in Italy.',
    'new-zealand': 'You need a Fee Paying Student Visa to study full-time in New Zealand.',
    'singapore': "You need a Singapore Student's Pass to study full-time at an approved institution.",
    'japan': 'You need a Japan College Student Visa to study full-time in Japan.',
    'austria': 'You need an Austrian Student Residence Permit to study full-time in Austria.',
    'belgium': 'You need a Belgian Student Visa (Type D) to enroll in higher education in Belgium.',
    'czech-republic': 'You need a Czech Student Visa or Residence Permit to study full-time in Czech Republic.',
    'denmark': 'You need a Danish Student Residence Permit (ST1) to study full-time in Denmark.',
    'finland': 'You need a Finnish Student Residence Permit to study full-time in Finland.',
    'hungary': 'You need a Hungarian Student Visa (Type D) to enroll in university studies in Hungary.',
    'iceland': 'You need an Icelandic Student Residence Permit to study full-time in Iceland.',
    'norway': 'You need a Norwegian Student Residence Permit to study full-time in Norway.',
    'poland': 'You need a Polish National Visa for Studies (Type D) to study in Poland.',
    'portugal': 'You need a Portuguese Student Visa (Type D4/D5) to study in Portugal.',
    'sweden': 'You need a Swedish Residence Permit for Higher Education to study in Sweden.',
    'switzerland': 'You need a Swiss National Visa (Type D) to study full-time in Switzerland.',
    'turkey': 'You need a Turkish Student Residence Permit to study in Turkey.',
    'argentina': 'You need an Argentine Student Visa to study full-time in Argentina.',
    'netherlands': 'You need a Dutch Student Visa (MVV) and Residence Permit to study in the Netherlands.',
  };
  return map[c] || `You need a Student Visa to study full-time at a recognized institution in ${country}.`;
}
